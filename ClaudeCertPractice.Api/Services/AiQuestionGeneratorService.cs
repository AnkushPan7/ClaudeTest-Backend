...
public class AiQuestionGeneratorService
{
        ...
        CancellationToken ct = default)
    {
        ...
        while (remaining > 0)
        {
            ...
            var batch = await GenerateBatchAsync(
                apiKey, sourceText, learningUrl, batchSize, sectionHint, batchNum, all.Count, existingTitles, ct);
            all.AddRange(batch);
        ...
        CancellationToken ct)
    {
        ...
        var prompt = $$"""
            ...
            Learning material URL: {{learningUrl}}
            (Text extracted from that page is below.)
